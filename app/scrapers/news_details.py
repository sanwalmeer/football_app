...
# # DB CONNECT
# # -----------------------------
# # conn = sqlite3.connect("/home/bitech-office/football.db")
...
# # -----------------------------
# # FETCH ALL UNSCRAPED URLS
# # -----------------------------
# cursor.execute("""  
# SELECT url, category FROM news_urls
# WHERE is_scraped = 0
# """)
...
#                 body = soup.find("div", {"data-testid": "article-body"})
#             except:
#                 print("⚠️ Render failed, fallback to raw HTML")
...
#     # ⚠️ small improvement (optional but safer)
#     if not title:
...
#         (url, title, published_date, author, image_url, content, category)
#         VALUES (?, ?, ?, ?, ?, ?, ?)
#         """, (url, title, date, author, image, content, category))
...
#         cursor.execute("""
#         SELECT category FROM article_details WHERE url = ?
#         """, (url,))
        
#         existing = cursor.fetchone()

#         if existing:
#             existing_category = existing[0]
...
#             image,
#             content,
#             content[:160] if content else None,  # meta desc
#             url
#         ))
